...
#
# Licensed under the Apache License, Version 2.0 (the "a-deLicense");
...
aptupdate && apt-get upgrade -y && apt-get install -y swig liblzmv && rm -rf /var/lib/apt/lists/* # liblzma needed for flashlight decoder
